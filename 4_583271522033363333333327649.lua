...
if gg.isPackageInstalled("fucklog.by.decbydbc") then 
print("Log GG yi sil öyle dene😂") 
os.exit() end 
if gg.isPackageInstalled("com.hckeam.mjgql") then 
print("Decrypt GG yi sil öyle dene😂") 
os.exit() end 
if gg.isPackageInstalled(("com.wtkc.gg")) then 
print(("Cihazında bir decompiler uygulaması farkettim 😂")) 
os.exit() end 
if gg.isPackageInstalled("com.guoshi.httpcanary") then 
gg.alert("Cihazında bir decompiler uygulaması farkettim 😂") 
os.exit() end 
...
gg.toast("🎉 BY [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ 🎉")
gg.sleep(466)
gg.toast("😈CODER MAKER [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ 😈")
gg.sleep(466)
gg.toast("YUKLENİYOR COK AZ KALDİ")
gg.sleep(466)
gg.toast("VE BİTTİ...")
gg.sleep(466)
gg.alert("❤️ HOŞGELDİN SEFALAR GETİRDİN ❤️ ") 
gg.alert("🎉 LUTFEN YARDİM İÇİN WİN SS ATİN 🎉")  
gg["setVisible"](true)
function HME(...)
_ENV[161] = gg["multiChoice"]({"╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™─────╮\n🛡𝐀𝐍𝐓𝐈𝐁𝐀𝐍 𝐌𝐄𝐍𝐔 \n ╚➤[♡ᒪOᗷY♡] \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™─────╯","╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™─────╮\n ⚔𝐒𝐈𝐋𝐀𝐇 𝐌𝐄𝐍𝐔\n ╚➤[☆ᒪOᗷY+OYᑌᑎ☆] \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╯","╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╮\n 💥𝐎𝐘𝐔𝐍 𝐌𝐄𝐍𝐔 \n ╚➤[♧OYᑌᑎ♧] \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╯","╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╮\n 🎃 EĞLENCE MENU 🎃 \n╚➤[♤ᒪOᗷY+OYᑌᑎ♤] \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╯","╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╮\n 👀 WALLHACK MENU 👀\n╚➤[◇ᒪOᗷY+OYᑌᑎ◇] \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╯","╭───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╮\n🚪𝐄𝐗𝐈𝐓 \n╰───── [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ─────╯"}, nil, "╭════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╮\n [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ♥️ \n Telegram : @KANALRLX \n Hayırlı Ramazanlar💖  ❄Pubg 1.4.0 \n╰════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╯")
if _ENV[161] == nil then
else
if _ENV[161][1] == true then
BYPASS()
end
if _ENV[161][2] == true then
LessRecoil()
end
if _ENV[161][3] == true then
NoRecoil()
end
if _ENV[161][4] == true then
skyjump()
end
if _ENV[161][5] == true then
skyoff()
end
if _ENV[161][6] == true then
EXIT()
end
end
ggwp = -1
...
function skyjump(...)
EGL = gg["multiChoice"]({"᚛🚙᚜ Zıplayan Araba ","᚛🐇᚜ Ultra Yükseğe Zıplaʸᵉⁿⁱ","᚛🚁᚜ Hızlı Paraşütᵘᶜᵃᵏᵗᵃ","᚛🦄᚜ Flash V1ᵃᶜ","᚛🦄᚜ Flash V1ᵏᵃᵖᵃᵗ","🅶🅴🆁🅸"}, nil, "╭════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ═══════╮\n [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ V7 ՏᏟᎡᏆᏢͲ🖤 \n╰════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ═══════╯")
if EGL == nil then
else
if EGL[1] == true then
ucur()
...
flash1 = gg.getResults(69)
gg.editAll("-1292522029219577856", gg.TYPE_QWORD)
gg.clearResults()
gg.toast("⚡HAKAN YAVAŞ CİGERİMİ SOKTUN⚡")
end
...
gg["getResultCount"]()
gg["toast"]("Bekle")
gg["toast"]("😈 Sky Jump aktif [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ 😈")
end
...
function BYPASS(...)
_ENV[26] = gg["multiChoice"]({"🛡️Antiban V1 GL&KR ","🧹Report Clear ","🛡️Antiban V2 GL&KR","🅶🅴🆁🅸"}, nil, "╭════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╮\n [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ V7 ՏᏟᎡᏆᏢͲ🖤 \n ✩｡:*•.─────  ★  ─────.•*:｡✩\nＡｎｔｉｂａｎ　Ｍｅｎｕ\n╰════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╯")
if _ENV[26] == nil then
else
if _ENV[26][1] == true then
ANT1()
end
if _ENV[26][2] == true then
ANT2()
end
if _ENV[26][3] == true then
ANT3()
end
if _ENV[26][4] == true then
HME()
end
end
ggwp = -31
...
function ANT1(...)
gg.alert("ðŸ‘‘zeron antiban v2 aciliyo")
gg.alert("(:ðŸ‘‘zeron antiban v3 acmayi unutmag:)")
gg.alert(" :) CODLAYAN=@jokermemo31 ðŸ‡¹ðŸ‡·")
gg.sleep(300)
gg.toast("10%")
gg.sleep(300)
gg.toast("20%")
...
gg.sleep(300)
gg.toast("100%")
gg.alert("ðŸ‘‘ZERON ANTIBAN v2 ACILIYOðŸ‘‘") 
gg.clearResults()
...
gg.clearResults()
gg.alert("ðŸ¤£anne bittiðŸ¤£")
gg.alert(" :) CODLAYAN=@jokermemo31 ðŸ‡¹ðŸ‡·")
gg.toast("komut dosyasÄ± kapanÄ±yo")
gg.sleep(800)
gg.toast("10%")
gg.sleep(300)
gg.toast("20%")
...
gg.toast("100%")
gg.sleep(800)
gg.toast("ðŸ‘‘komut dosyasi kapandÄ±ðŸ‘‘") 
...
function LessRecoil(...)
SF = gg["multiChoice"]({"❌ X Hasar Efekti","🔥 Magic + Kafadan","⛑ Less Recoil","🎯 No Recoil","❄ Bullet Tracking","💢 Yüksek Hasar","💎 360 AimBot","➕ Small Croshair","🧨 Hızlı Mermi++++","✔ İleri Uzanan Kolᵃᶜ","❌ İleri Uzanan Kolᵏᵃᵖᵃᵗ","🔙GERİ"}, nil, "╭════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╮\n [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ \n Telegram : @KANALRLX  \n ╰════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╯")
if SF == nil then
else
if SF[1] == true then
SF1()
...
gg.setRanges(gg.REGION_CODE_APP)
gg.clearResults()
gg.searchNumber(-1.427811e28, gg.TYPE_FLOAT)
gg.getResultsCount()
gg.getResults(0)
gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
gg.clearResults()
gg.searchNumber(-3.2543799e30, gg.TYPE_FLOAT)
gg.getResultsCount()
gg.getResults(0)
gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
...
gg.getResults(0)
gg.clearResults()
gg.toast("magic bullet ~ headshot aktif")
end
...
gg.clearResults()
gg.searchNumber("-511703038;-336586961:29", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("-511703038", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(2)
gg.editAll('-476053504', 4)
gg.clearResults()
gg.searchNumber("1.6615354e35;-5.8049376e26:9", 16, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("1.6615354e35", 16, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(6)
gg.editAll("1.6615351e35", 16)
gg.clearResults()
gg.searchNumber("-1903895621994000383",32,false,gg.SIGN_EQUAL,0, -1)
gg.getResults(10)
gg.editAll("-1903895621994000382",32)
gg.clearResults()
gg.searchNumber("2015175168", 16, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(6)
gg.editAll("0", 16)
gg.clearResults()
gg.searchNumber("2046820354;-336587221:9", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("2046820354", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(100)
gg.editAll("2046820353", 4)
gg.clearResults()
gg.searchNumber("-285787648;-290174237;-286131696;-286131696", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.refineNumber("-290174237", 4, false, gg.SIGN_EQUAL, 0, -1)
gg.getResultCount()
gg.getResults(0)
gg.clearResults()
...
gg.toast("Aimbot 360° Aktif ♥️°")
end
function NoRecoil(...)
ELN = gg["multiChoice"]({"📡 Anten","📹 iPad Mod","ACMA ⚠️","Cimen & Ağaç Kaldırma 🌲⛳","🔙GERİ"}, nil, "╭════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╮\n [ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™ ⚡ \n Telegram : @KANALRLX  \n ╰════════[ᖇ ᒪ ᙭] 𝙷𝙰𝙲𝙺𝚂 ™═══════╯")
if ELN == nil then
else
if ELN[1] == true then
ELN1()
...
gg.clearResults()
gg.toast("✅elektrik diregi gibi oldun ✅")
end
...
gg["clearResults"]()
gg["toast"]("ACMA DEDİMİZ HALDE NİYE ACİON OÇ")
end
...
gg["editAll"]("0", gg.TYPE_FLOAT)
gg["clearResults"]()
gg["toast"]("Çimenler + Ağaçlar Kaldırlıldı 🌲")
end

function EXIT(...)
print("GORUSURUZ TEKRAR GEL ♥️🎉 ")
gg["skipRestoreState"]()
gg["setVisible"](true)
os["exit"]()
end
